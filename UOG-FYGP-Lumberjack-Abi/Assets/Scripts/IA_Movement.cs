...
//     version 1.14.2
//     from Assets/Scripts/IA_Movement.inputactions
//
...
/// <summary>
/// Provides programmatic access to <see cref="InputActionAsset" />, <see cref="InputActionMap" />, <see cref="InputAction" /> and <see cref="InputControlScheme" /> instances defined in asset "Assets/Scripts/IA_Movement.inputactions".
/// </summary>
/// <remarks>
...
public partial class @IA_Movement: IInputActionCollection2, IDisposable
{
    ...
    ""maps"": [
        {
            ""name"": ""Main"",
            ""id"": ""fcf5e706-8d2d-44cf-a95b-717d9f78fdbf"",
            ""actions"": [
                {
                    ""name"": ""Move"",
                    ""type"": ""Button"",
                    ""id"": ""7ceed2f4-4a31-4be9-92fd-96cc47d94ea8"",
                    ""expectedControlType"": """",
                    ""processors"": """",
                    ""interactions"": """",
            ...
            ""bindings"": [
                {
                    ""name"": """",
                    ""id"": ""e756fc3e-51aa-4ead-b015-71da6f9905e1"",
    ...
    ~@IA_Movement()
    {
        UnityEngine.Debug.Assert(!m_Main.enabled, "This will cause a leak and performance issues, IA_Movement.Main.Disable() has not been called.");
    }
    ...
    public struct MainActions
    {
        ...
        /// </summary>
        public MainActions(@IA_Movement wrapper) { m_Wrapper = wrapper; }
        /// <summary>
